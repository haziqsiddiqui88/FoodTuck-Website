...
{/*Navbar end*/}
    ...
    {/* navbar end */}
      ...
      <main className="py-8 px-4 sm:py-12 sm:px-6 md:px-16 lg:px-28">
    <table className="w-full border-collapse text-sm sm:text-base">
      <thead>
        <tr className="text-left">
          <th className="p-2 sm:p-4 font-medium">Product</th>
          <th className="p-2 sm:p-4 font-medium">Price</th>
          <th className="p-2 sm:p-4 font-medium">Quantity</th>
          <th className="p-2 sm:p-4 font-medium">Total</th>
          <th className="p-2 sm:p-4 font-medium">Remove</th>
        </tr>
      </thead>
      <tbody>
        {cartItems.map((item, index) => (
          <tr key={index} className="border-b">
            ...
            <td
              className="p-2 sm:p-4 text-red-500 text-xl sm:text-3xl cursor-pointer"
    ...
    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mt-8 sm:mt-10 space-y-6 lg:space-y-0 lg:space-x-6">
      <div className="w-full lg:w-1/2">
        <h2 className="text-base sm:text-lg font-semibold mb-2">Coupon Code</h2>
        <div className="flex items-center">
          ...
          <button
            ...
            className="bg-[#ff9f0d] hover:bg-orange-500 text-white px-4 sm:px-6 py-2 rounded-r font-semibold"
          >
            Apply
          </button>
        </div>
