...
export default function page() {
 ...
 <section className="w-full py-16 md:py-24">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/2 space-y-6">
              <div className="flex items-center gap-2">
                <span className="font-playwrite  text-[#ff9f0d] text-3xl font-medium">About us</span>
      ...
      <section className="w-full bg-[#fff]" style={{ backgroundImage: `url('/menu-bg.png')` }}>
        <Testimonials />
      </section>
      ...
      <section className="w-full py-20 bg-white" >
        <div className="container mx-auto px-4 md:px-6" >
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl text-black font-bold mb-4">Our Food Menu</h2>
        ...
        <div className="lg:-ml-16 grid grid-cols-1  md:grid-cols-2  md:gap-2 mt-7 w-full lg:full" style={{ backgroundImage: `url('/bg-3.png')` }}>
